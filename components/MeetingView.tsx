...
import { getStore, addLog, subscribeToStore, upsertUser } from '../services/store';
      ...
      {showUserModal && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-[110] p-4">
           <form onSubmit={handleSaveUser} className="bg-white w-full max-w-md rounded-[2.5rem] shadow-2xl p-10 space-y-6 animate-in zoom-in max-h-[90vh] overflow-y-auto">
              ...
              <button type="submit" className="w-full py-4 bg-slate-900 text-white rounded-2xl font-black uppercase tracking-widest text-xs shadow-xl">Enregistrer le membre</button>
           </form>
        </div>
      )}
    </div>
