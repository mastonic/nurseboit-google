      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredPatients.map(patient => (
          ...
          >
            ...
            <p className="text-emerald-500 text-[10px] font-black uppercase tracking-widest mb-4 truncate">{patient.careType}</p>
            
            <div className="space-y-2 text-xs font-bold text-slate-400 italic">
               <p className="flex items-center gap-2"><i className="fa-solid fa-phone text-slate-300 text-[10px]"></i>{patient.phone}</p>
               <p className="truncate flex items-center gap-2"><i className="fa-solid fa-location-dot text-slate-300 text-[10px]"></i>{patient.address}</p>
            </div>
